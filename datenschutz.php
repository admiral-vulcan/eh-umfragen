<section id="intro">
    <header>
        <p class="seal"><a href="https://datenschutz-generator.de/" title="Rechtstext von Dr. Schwenke - für weitere Informationen bitte anklicken." target="_blank" rel="noopener noreferrer nofollow">Erstellt mit dem kostenlosen Datenschutz-Generator.de von Dr. Thomas Schwenke.</a></p>
        ...
        <div style="text-align: justify; hyphens: auto;">
            ...
            <p>Stand: 4. Dezember 2022</p>
            <h2>Inhaltsübersicht</h2>
            <ul class="index">
                <li><a class="index-link" href="#Einleitung">Einleitung</a></li>
                <li><a class="index-link" href="#Verantwortlicher">Verantwortlicher</a></li>
                <li><a class="index-link" href="#Übersicht">Übersicht der Verarbeitungen</a></li>
                <li><a class="index-link" href="#Rechtsgrundlagen">Maßgebliche Rechtsgrundlagen</a></li>
                <li><a class="index-link" href="#Sicherheitsmaßnahmen">Sicherheitsmaßnahmen</a></li>
                <li><a class="index-link" href="#Übermittlung">Übermittlung von personenbezogenen Daten</a></li>
                <li><a class="index-link" href="#Datenverarbeitung">Datenverarbeitung in Drittländern</a></li>
                <li><a class="index-link" href="#Löschung">Löschung von Daten</a></li>
                <li><a class="index-link" href="#Kontakt">Kontakt- und Anfragenverwaltung</a></li>
                <li><a class="index-link" href="#Umfragen">Umfragen und Befragungen</a></li>
                <li><a class="index-link" href="#Änderung">Änderung und Aktualisierung der Datenschutzerklärung</a></li>
                <li><a class="index-link" href="#Betroffenenrechte">Rechte der betroffenen Personen</a></li>
                <li><a class="index-link" href="#Begriffsdefinitionen">Begriffsdefinitionen</a></li>
            </ul>
            <h2 id="Verantwortlicher" style="padding-top: 100px; margin-top: -100px;">Verantwortlicher</h2>
            <img class="iadd" alt="Adresse" style="pointer-events: none;">
            <br>
            <br>
            E-Mail-Adresse:
            <p>kontakt@eh-umfragen.de</p>
            Impressum:
            <p><a href="https://www.eh-umfragen.de/?content=impressum" target="_blank">eh-umfragen.de/impressum</a></p>
            <h2 id="Übersicht">Übersicht der Verarbeitungen</h2>
            ...
            <h2 id="Übermittlung">Übermittlung von personenbezogenen Daten</h2>
            <p>Im Rahmen unserer Verarbeitung von personenbezogenen Daten kommt es vor, dass die Daten an andere Stellen, Unternehmen, rechtlich selbstständige Organisationseinheiten oder Personen übermittelt oder sie ihnen gegenüber offengelegt werden. Zu den Empfänger*innen dieser Daten können z.B. mit IT-Aufgaben beauftragte Dienstleister*innen oder Anbieter*innen von Diensten und Inhalten, die in eine Webseite eingebunden werden, gehören. In solchen Fall beachten wir die gesetzlichen Vorgaben und schließen insbesondere entsprechende Verträge bzw. Vereinbarungen, die dem Schutz Ihrer Daten dienen, mit den Empfänger*innen Ihrer Daten ab.</p>
            <h2 id="Datenverarbeitung">Datenverarbeitung in Drittländern</h2>
            <p>Sofern wir Daten in einem Drittland (d.h., außerhalb der Europäischen Union (EU), des Europäischen Wirtschaftsraums (EWR)) verarbeiten oder die Verarbeitung im Rahmen der Inanspruchnahme von Diensten dritter Personen oder der Offenlegung bzw. Übermittlung von Daten an andere Personen, Stellen oder Unternehmen stattfindet, erfolgt dies nur im Einklang mit den gesetzlichen Vorgaben. </p>
            ...
            <h2 id="Löschung">Löschung von Daten</h2>
            ...
            <h2 id="Kontakt">Kontakt- und Anfragenverwaltung</h2>
            ...
            <h2 id="Betroffenenrechte">Rechte der betroffenen Personen</h2>
            ...
            <h2 id="Begriffsdefinitionen">Begriffsdefinitionen</h2>
