    ...
    <header>
        ...
        <div style="text-align: justify; hyphens: auto;">
            ...
            <ul class="index">
                ...
                <li><a class="index-link" href="#m15">Verantwortlicher</a></li>
                <li><a class="index-link" href="#m16">Übersicht der Verarbeitungen</a></li>
                <li><a class="index-link" href="#m17">Maßgebliche Rechtsgrundlagen</a></li>
                <li><a class="index-link" href="#m18">Sicherheitsmaßnahmen</a></li>
                <li><a class="index-link" href="#m19">Übermittlung von personenbezogenen Daten</a></li>
                <li><a class="index-link" href="#m20">Datenverarbeitung in Drittländern</a></li>
                <li><a class="index-link" href="#m21">Löschung von Daten</a></li>
                <li><a class="index-link" href="#m22">Kontakt- und Anfragenverwaltung</a></li>
                <li><a class="index-link" href="#m23">Umfragen und Befragungen</a></li>
                <li><a class="index-link" href="#m24">Änderung und Aktualisierung der Datenschutzerklärung</a></li>
                <li><a class="index-link" href="#m25">Rechte der betroffenen Personen</a></li>
                <li><a class="index-link" href="#m26">Begriffsdefinitionen</a></li>
            </ul>
            <h2 id="m15" style="padding-top: 100px; margin-top: -100px;">Verantwortlicher</h2>
            ...
            <h2 id="m16">Übersicht der Verarbeitungen</h2>
            ...
            <h2 id="m17">Maßgebliche Rechtsgrundlagen</h2>
            ...
            <h2 id="m18">Sicherheitsmaßnahmen</h2>
            ...
            <h2 id="m19">Übermittlung von personenbezogenen Daten</h2>
            ...
            <h2 id="m20">Datenverarbeitung in Drittländern</h2>
            ...
            <h2 id="m21">Löschung von Daten</h2>
            ...
            <h2 id="m22">Kontakt- und Anfragenverwaltung</h2>
            ...
            <h2 id="m23">Umfragen und Befragungen</h2>
            ...
            <h2 id="m24">Änderung und Aktualisierung der Datenschutzerklärung</h2>
            ...
            <h2 id="m25">Rechte der betroffenen Personen</h2>
            ...
            <h2 id="m26">Begriffsdefinitionen</h2>
