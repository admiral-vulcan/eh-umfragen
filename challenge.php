<section id="intro">
    ...
    <div id="g_id_onload"
         data-client_id="459229855435-uk124vcjalr4v348krnclh4n6ma9s76p.apps.googleusercontent.com"
                ...
                if (googleStyle.display === 'none') {
                    ...
                    script.onload = function () {
                        google.accounts.id.initialize({
                            client_id: '459229855435-uk124vcjalr4v348krnclh4n6ma9s76p.apps.googleusercontent.com',
